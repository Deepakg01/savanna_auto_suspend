...
def test_tc02_verify_minimum_auto_suspend_time(client):
    ...
    assert query_response.status_code in [200, 202, 403, 500, 503], (
...
def test_tc03_workspace_should_not_suspend_before_configured_time(client):
    ...
    assert query_response.status_code in [200, 202, 403, 500, 503], query_response.text
...
def test_tc04_keep_alive_should_reset_suspend_timer(client):
    ...
    assert query_response_1.status_code in [200, 202, 403, 500, 503], query_response_1.text
    ...
    assert query_response_2.status_code in [200, 202, 403, 500, 503], query_response_2.text
